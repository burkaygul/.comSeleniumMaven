...
public class C03_WebElementMethodlari {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(aramaKutusuElementi.getSize()); //(958, 38)
        ...
        System.out.println(aramaKutusuElementi.getLocation()); // (330, 11)

        System.out.println(aramaKutusuElementi.getRect().getDimension()); // (958, 38)
